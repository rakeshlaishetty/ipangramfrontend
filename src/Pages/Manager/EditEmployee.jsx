...
const EditEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
        const newdata = {...formData,id:employeeData._id}
      console.log("Form submitted:", formData);
      try {
        const response = await EmployeesApi.UpdateEmployees(newdata);
                ...
                >
                  ...
                  {locations.map((loc) => (
                    <option
                      key={loc}
                      value={loc}
                      selected={loc === employeeData.location} // Set selected attribute based on the comparison
                    >
                      {loc}
                    </option>
                  ))}
